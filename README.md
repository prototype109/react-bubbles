...
A token is used for client side authentication.
It is obtained when a user logs in with the proper
credentials and is present throught the application
through local storage. It is used when making requests to pages that are considered private and are protected by a PrivateRoute.

- [ ] What steps can you take in your web apps to keep your data secure?

Make PrivateRoutes to secure data on some pages only rendering when there is a token present, but normally the backend deals with application security.

- [ ] Describe how web servers work.

A web server is any computer that runs a program to serve the specified site on request or a computer that has the website hosted on it.
